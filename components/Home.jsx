      ...
      <div className="flex items-center h-screen w-full down-lg:mx-auto down-lg:justify-center xs:text-left down-lg:text-center ">
        ...
        <div className="from-lg:ml-100/3 from-lg:w-2/3">
          <div className="mx-auto max-w-550 custom-md-1:max-w-450">
            ...
            <p className="font-Open-sans mt-15 mb-15 leading-lh-35 down-lg:mt-2.5 down-lg:mb-23 down-lg:text-fs-15 down-lg:leading-lh-30">
            I'm a versatile professional working as a Product Manager, Scrum Master, and Front-End Developer. Focused on creating seamless, user-friendly experiences, I am passionate about building outstanding software that enhances the lives of users. My expertise in product management ensures strategic alignment, while my Scrum Master skills foster efficient, collaborative teams. Combining these roles with front-end development, I deliver high-quality, impactful solutions.
            </p>
            <div
              id="link-about"
